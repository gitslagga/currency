...
-- ----------------------------
INSERT INTO `qq3479015851_admin` VALUES ('1', '', 'admin', '币创网', '', 'e10adc3949ba59abbe56e057f20f883e', '0', '0', '0', '0', '0', '1');
...
INSERT INTO `qq3479015851_article` VALUES ('29', 'THC众筹完成公告', '感谢大家一直以来对币创网的支持，经过多天的THC众筹现已认购2388043枚THC，剩下的币全部销毁处理。2016-12-16日09：00开盘，请互相转告；祝大家玩的愉快。', '1', 'aaa', '0', '1', '1', '0', '1481817782', '1481817653', '1', '592d295a0cb20.png');
...
CREATE TABLE `qq3479015851_coin` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='币种配置表';
...
INSERT INTO `qq3479015851_link` VALUES ('9', '币创网', '币创网', 'https://www.thbtc.com', '59257b03bdfdd.gif', '', '', '0', '1481608045', '1481608026', '1');
...
INSERT INTO `qq3479015851_mycz_type` VALUES ('2', '', '', '', '币创科技有限公司', 'weixin', '微信转账支付', '', 'weixinzhifu', '123456', '', '', '需要在联系方式里面设置微信账号', '0', '0', '0', '1');
INSERT INTO `qq3479015851_mycz_type` VALUES ('3', '10000', '100', '', '', 'bank', '网银转账支付', '', '', '', '57de3a186ea05.jpg', '', '需要在联系方式里面按照格式天数收款银行账号', '0', '0', '0', '0');
...
CREATE TABLE `qq3479015851_user_bank_type` (
  ...
  KEY `status` (`status`),
  KEY `name` (`name`)
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='常用银行地址';
