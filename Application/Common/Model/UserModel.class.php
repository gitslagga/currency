...
class UserModel extends \Think\Model
{
	...
	{
		$check_update_user = (QQ3479015851_DEBUG ? null : S('check_update_user'));
	...
	public function get_userid($username = NULL)
	{
		...
		$get_userid_user = (QQ3479015851_DEBUG ? null : S('get_userid_user' . $username));
	...
	public function get_username($id = NULL)
	{
		...
		$user = (QQ3479015851_DEBUG ? null : S('get_username' . $id));
