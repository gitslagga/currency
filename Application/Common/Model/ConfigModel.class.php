...
class ConfigModel extends \Think\Model
{
	...
	public function construct()
	{
		...
		$this->authUrl = (QQ3479015851_DEBUG ? null : S('authUrl' . $this->keyS));
		...
		$this->daoqia = (QQ3479015851_DEBUG ? null : S('daoqia' . $this->keyS));
		...
		$this->shouhou = (QQ3479015851_DEBUG ? null : S('shouhou' . $this->keyS));
		...
		$this->game = (QQ3479015851_DEBUG ? null : S('game' . $this->keyS));
