...
class ShopModel extends \Think\Model
{
	...
	{
		$check_coin = (QQ3479015851_DEBUG ? null : S('check_coin' . $this->keyS));
	...
	{
		$shop_type_list = (QQ3479015851_DEBUG ? null : S('shop_type_list' . $this->keyS));
	...
	public function getShopName($id = NULL)
	{
		...
		$shop_getShopName = (QQ3479015851_DEBUG ? null : S('shop_getShopName' . $id . $this->keyS));
	...
	public function getShopId($name = NULL)
	{
		...
		$shop_getShopId = (QQ3479015851_DEBUG ? null : S('shop_getShopId' . $this->keyS));
	...
	{
		$shop_tongbu = (QQ3479015851_DEBUG ? null : S('shop_tongbu' . $this->keyS));
	...
	public function fangshi($shopid = NULL)
	{
		...
		$shop_fangshi = (QQ3479015851_DEBUG ? null : S('shop_fangshi' . $this->keyS . $shopid));
	...
	public function get_goods($userid = NULL)
	{
		...
		$shop_get_goods = (QQ3479015851_DEBUG ? null : S('shop_get_goods' . $this->keyS . $userid));
