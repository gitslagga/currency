...
class IndexController extends HomeController
{
	public function index()
	{
		...
		$indexAdver = (QQ3479015851_DEBUG ? null : S('index_indexAdver'));
		...
		switch(C('index_html')){
			case "a":
				...
				$indexArticle = (QQ3479015851_DEBUG ? null : S('index_indexArticle'));
			...
			default:
				$indexArticleType = (QQ3479015851_DEBUG ? null : S('index_indexArticleType'));
		...
		$indexLink = (QQ3479015851_DEBUG ? null : S('index_indexLink'));
